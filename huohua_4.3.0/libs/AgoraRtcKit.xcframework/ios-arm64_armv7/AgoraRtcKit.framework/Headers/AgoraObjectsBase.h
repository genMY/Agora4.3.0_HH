 ...
 */
__attribute__((visibility("default"))) @interface AgoraRtcVideoCanvasBase : NSObject
/**
 ...
 */
__attribute__((visibility("default"))) @interface AgoraRtcLocalVideoStatsBase : NSObject
/**
...
__attribute__((visibility("default"))) @interface AgoraRtcRemoteVideoStatsBase : NSObject
/** Time delay (ms).
 */
 ...
 */
__attribute__((visibility("default"))) @interface AgoraRtcRemoteAudioStatsBase : NSObject
/**
 ...
 */
__attribute__((visibility("default"))) @interface AgoraRtcAudioVolumeInfoBase : NSObject
 ...
 */
__attribute__((visibility("default"))) @interface AgoraLiveTranscodingUserBase : NSObject
 ...
 */
__attribute__((visibility("default"))) @interface AgoraLiveTranscodingBase : NSObject
...
@end
/** The definition of AgoraTranscodingVideoStreamBase.
 */
__attribute__((visibility("default"))) @interface AgoraTranscodingVideoStreamBase: NSObject
/**
 ...
 */
__attribute__((visibility("default"))) @interface AgoraTranscodingVideoStream: AgoraTranscodingVideoStreamBase
/**
...
/** The definition of AgoraTranscodingVideoStream.
 */
__attribute__((visibility("default"))) @interface AgoraTranscodingVideoStreamS: AgoraTranscodingVideoStreamBase
/**
 * Remote user uid if sourceType is AgoraMediaSourceTypeRemote.
 */
@property (copy, nonatomic) NSString* _Nonnull remoteUserAccount;
 ...
 */
__attribute__((visibility("default"))) @interface AgoraLocalTranscoderConfigurationBase: NSObject
/**
...
/** The definition of AgoraLocalTranscoderConfiguration.
 */
__attribute__((visibility("default"))) @interface AgoraLocalTranscoderConfiguration: AgoraLocalTranscoderConfigurationBase
/**
...
/** The definition of AgoraLocalTranscoderConfiguration.
 */
__attribute__((visibility("default"))) @interface AgoraLocalTranscoderConfigurationS: AgoraLocalTranscoderConfigurationBase
/**
 * The video stream layout configuration in the transcoder.
 */
@property(copy, nonatomic) NSArray<AgoraTranscodingVideoStreamS *> *_Nullable videoInputStreams;
 ...
 */
__attribute__((visibility("default"))) @interface AgoraRtcConnectionBase: NSObject <NSCopying>
 ...
 * The AgoraRtcConnection for the AgoraRtcEngineKitEx.
 */
__attribute__((visibility("default"))) @interface AgoraRtcConnection: AgoraRtcConnectionBase
...
/**
 * The AgoraRtcConnectionS for the AgoraRtcEngineKitEx.
 */
__attribute__((visibility("default"))) @interface AgoraRtcConnectionS: AgoraRtcConnectionBase

/**
 * Init AgoraRtcConnectionS with channelId and localUserAccount
 *
 * @param channelId Unique channel name for the AgoraRTC session in the string.
 * @param localUserAccount Local User ID.
 * @return AgoraRtcConnectionS.
 */
- (instancetype _Nonnull)initWithChannelId:(NSString *_Nonnull)channelId localUserAccount:(NSString* _Nonnull)localUserAccount;
/* uid Local User ID. A 32-bit unsigned integer with a value ranging from 1 to
 * (2<sup>32</sup>-1). The `uid` must be unique and not set to 0 . Your app
 * must record and maintain the returned `uid` since the SDK does not do so.
 */
@property (nonatomic, copy) NSString* _Nonnull localUserAccount;
 ...
 */
__attribute__((visibility("default"))) @interface AgoraRecorderStreamInfoBase: NSObject
 ...
 * The configurations for the audio encoded freame.
 */
__attribute__((visibility("default"))) @interface AgoraEncodedVideoFrameInfoBase: NSObject
...
NS_SWIFT_NAME(AgoraExtensionInfoBase) __attribute__((visibility("default"))) @interface AgoraExtensionInfoBase : NSObject

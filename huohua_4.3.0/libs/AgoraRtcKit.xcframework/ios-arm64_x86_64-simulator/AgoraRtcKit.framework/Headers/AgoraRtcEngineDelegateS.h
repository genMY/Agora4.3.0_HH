 ...
 */
@protocol AgoraRtcEngineDelegateS <NSObject>
@optional
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didOccurError:(AgoraErrorCode)errorCode NS_SWIFT_NAME(rtcEngine(_:didOccurError:));
 ...
 */
- (void)rtcEngineRequestToken:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineRequestToken(_:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine tokenPrivilegeWillExpire:(NSString *_Nonnull)token NS_SWIFT_NAME(rtcEngine(_:tokenPrivilegeWillExpire:));
...
/**
   ...
   */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine licenseValidationFailure:(AgoraLicenseVerifyCode) error;
...
/** The SDK disconnected from the server.
 ...
 @param engine AgoraRtcEngineKit object
 */
- (void)rtcEngineConnectionDidInterrupted:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineConnectionDidInterrupted(_:));
 ...
 * @param engine The AgoraRtcEngineKit object.
 */
- (void)rtcEngineConnectionDidLost:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineConnectionDidLost(_:));
...
/** A connection is banned by the server.
 ...
 @param engine AgoraRtcEngineKit object
 */
- (void)rtcEngineConnectionDidBanned:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineConnectionDidBanned(_:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine networkTypeChanged:(AgoraNetworkType)type NS_SWIFT_NAME(rtcEngine(_:networkTypeChanged:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine permissionError:(AgoraPermissionType)type NS_SWIFT_NAME(rtcEngine(_:permissionError:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine connectionChangedToState:(AgoraConnectionState)state reason:(AgoraConnectionChangedReason)reason NS_SWIFT_NAME(rtcEngine(_:connectionChangedTo:reason:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine wlAccMessage:(AgoraWlAccReason)reason action:(AgoraWlAccAction)action wlAccMsg:(NSString * _Nonnull)wlAccMsg NS_SWIFT_NAME(rtcEngine(_:wlAccMessage:action:wlAccMsg:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine wlAccStats:(AgoraWlAccStats * _Nonnull)currentStats averageStats:(AgoraWlAccStats * _Nonnull)averageStats NS_SWIFT_NAME(rtcEngine(_:wlAccStats:averageStats:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine reportRtcStats:(AgoraChannelStats * _Nonnull)stats NS_SWIFT_NAME(rtcEngine(_:reportRtcStats:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine lastmileQuality:(AgoraNetworkQuality)quality NS_SWIFT_NAME(rtcEngine(_:lastmileQuality:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine lastmileProbeTestResult:(AgoraLastmileProbeResult * _Nonnull)result NS_SWIFT_NAME(rtcEngine(_:lastmileProbeTest:));
 ...
 * 1: Removed.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine device:(NSString * _Nonnull)deviceId type:(AgoraMediaDeviceType)deviceType stateChanged:(NSInteger)state NS_SWIFT_NAME(rtcEngine(_:device:type:stateChanged:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didOccurEncryptionError:(AgoraEncryptionErrorType)errorType NS_SWIFT_NAME(rtcEngine(_:didOccur:));
/**
   ...
   */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine uploadLogResultRequestId:(NSString * _Nonnull)requestId success:(BOOL)success reason:(AgoraUploadErrorReason)reason NS_SWIFT_NAME(rtcEngine(_:uploadLogResultRequestId:success:reason:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didJoinChannel:(NSString * _Nonnull)channel withUserAccount:(NSString * _Nonnull)userAccount elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:didJoinChannel:withUserAccount:elapsed:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didRejoinChannel:(NSString * _Nonnull)channel withUserAccount:(NSString * _Nonnull)userAccount elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:didRejoinChannel:withUserAccount:elapsed:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didClientRoleChanged:(AgoraClientRole)oldRole newRole:(AgoraClientRole)newRole newRoleOptions:(AgoraClientRoleOptions * _Nullable)newRoleOptions NS_SWIFT_NAME(rtcEngine(_:didClientRoleChanged:newRole:newRoleOptions:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didClientRoleChangeFailed:(AgoraClientRoleChangeFailedReason)reason currentRole:(AgoraClientRole)currentRole NS_SWIFT_NAME(rtcEngine(_:didClientRoleChangeFailed:currentRole:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didLeaveChannelWithStats:(AgoraChannelStats * _Nonnull)stats NS_SWIFT_NAME(rtcEngine(_:didLeaveChannelWith:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine networkQuality:(NSString* _Nonnull)userAccount txQuality:(AgoraNetworkQuality)txQuality rxQuality:(AgoraNetworkQuality)rxQuality NS_SWIFT_NAME(rtcEngine(_:networkQuality:txQuality:rxQuality:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine firstLocalAudioFramePublished:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:firstLocalAudioFramePublished:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine localAudioStats:(AgoraRtcLocalAudioStats * _Nonnull)stats NS_SWIFT_NAME(rtcEngine(_:localAudioStats:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine localAudioStateChanged:(AgoraAudioLocalState)state error:(AgoraAudioLocalError)error NS_SWIFT_NAME(rtcEngine(_:localAudioStateChanged:error:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didAudioRouteChanged:(AgoraAudioOutputRouting)routing NS_SWIFT_NAME(rtcEngine(_:didAudioRouteChanged:));
...
/** The audio mixing file playback stopped after calling [startAudioMixing]([AgoraRtcEngineKit startAudioMixing:loopback:replace:cycle:]).
 ...
 @param engine AgoraRtcEngineKit object
 */
- (void)rtcEngineLocalAudioMixingDidFinish:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineLocalAudioMixingDidFinish(_:));
 ...
 */
- (void)rtcEngineDidAudioEffectFinish:(AgoraRtcEngineKitS *_Nonnull)engine soundId:(int)soundId NS_SWIFT_NAME(rtcEngineDidAudioEffectFinish(_:soundId:));
...
/** A camera turned on and is ready to capture video.
 ...
 @param engine AgoraRtcEngineKit object
 */
- (void)rtcEngineCameraDidReady:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineCameraDidReady(_:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine cameraFocusDidChangedToRect:(CGRect)rect NS_SWIFT_NAME(rtcEngine(_:cameraFocusDidChangedTo:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine cameraExposureDidChangedToRect:(CGRect)rect NS_SWIFT_NAME(rtcEngine(_:cameraExposureDidChangedTo:));
...
/** The video playback stopped.
 ...
 @param engine AgoraRtcEngineKit object
 */
- (void)rtcEngineVideoDidStop:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineVideoDidStop(_:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine firstLocalVideoFramePublishedWithElapsed:(NSInteger)elapsed sourceType:(AgoraVideoSourceType)sourceType NS_SWIFT_NAME(rtcEngine(_:firstLocalVideoFramePublishedWithElapsed:sourceType:));
...
/** The first local frame displayed on the video window.
 ...
 @param sourceType source type of the orignated video source. See \ref AgoraVideoSourceType.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine firstLocalVideoFrameWithSize:(CGSize)size elapsed:(NSInteger)elapsed sourceType:(AgoraVideoSourceType)sourceType NS_SWIFT_NAME(rtcEngine(_:firstLocalVideoFrameWith:elapsed:sourceType:));
 ...
 * @param stats  Statistics of the local video stream. See \ref AgoraRtcLocalVideoStatsS.
 * @param sourceType source type of the orignated video source. See \ref AgoraVideoSourceType.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine localVideoStats:(AgoraRtcLocalVideoStatsS * _Nonnull)stats sourceType:(AgoraVideoSourceType)sourceType NS_SWIFT_NAME(rtcEngine(_:localVideoStats:sourceType:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didLocalPublishFallbackToAudioOnly:(BOOL)isFallbackOrRecover NS_SWIFT_NAME(rtcEngine(_:didLocalPublishFallbackToAudioOnly:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine videoRenderingTracingResultOfUserAccount:(NSString* _Nonnull)userAccount currentEvent:(AgoraMediaTraceEvent)currentEvent tracingInfo:(AgoraVideoRenderingTracingInfo * _Nonnull)tracingInfo NS_SWIFT_NAME(rtcEngine(_:videoRenderingTracingResultOfUserAccount:currentEvent:tracingInfo:));
 ...
 * user publishes a stream.
 ...
 @param elapsed Time elapsed (ms) from calling `joinChannelByToken` until this callback is triggered.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didJoinedOfUserAccount:(NSString* _Nonnull)userAccount elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:didJoinedOfUserAccount:elapsed:));
 ...
 *
 * @param engine The AgoraRtcEngineKit object.
 * @param userAccount The ID of the user who goes offline.
 * @param reason The reason why the user goes offline: #AgoraUserOfflineReason.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didOfflineOfUserAccount:(NSString* _Nonnull)userAccount reason:(AgoraUserOfflineReason)reason NS_SWIFT_NAME(rtcEngine(_:didOfflineOfUserAccount:reason:));
...
The SDK triggers this callback when the local user receives the stream message that the remote user sends by calling the \ref AgoraRtcEngineKit.sendStreamMessage:data: sendStreamMessage method within five seconds.
 ...
 @param engine   AgoraRtcEngineKit object.
 @param userAccount      User ID of the remote user sending the message.
 @param streamId Stream ID.
 @param data     Data received by the local user.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine receiveStreamMessageFromUserAccount:(NSString* _Nonnull)userAccount streamId:(NSInteger)streamId data:(NSData * _Nonnull)data NS_SWIFT_NAME(rtcEngine(_:receiveStreamMessageFromUserAccount:streamId:data:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didOccurStreamMessageErrorFromUserAccount:(NSString* _Nonnull)userAccount streamId:(NSInteger)streamId error:(NSInteger)error missed:(NSInteger)missed cached:(NSInteger)cached NS_SWIFT_NAME(rtcEngine(_:didOccurStreamMessageErrorFromUserAccount:streamId:error:missed:cached:));
...
/** The first audio frame received and decoded from the remote user.
 ...
 @param elapsed Time elapsed (ms) from calling `joinChannelByToken` until this callback is triggered.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine firstRemoteAudioFrameOfUserAccount:(NSString* _Nonnull)userAccount elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:firstRemoteAudioFrameOfUserAccount:elapsed:));


/** Occurs when the SDK decodes the first remote audio frame for playback.

 **Deprecated**  from v3.0.0. Use `AgoraAudioRemoteStateDecoding(2)` in the [remoteAudioStateChangedOfUserAccount]([AgoraRtcEngineDelegate rtcEngine:remoteAudioStateChangedOfUserAccount:state:reason:elapsed:]) callback instead.
 ...
 @param engine AgoraRtcEngineKit object.
 @param userAccount User ID of the remote user sending the audio stream.
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine firstRemoteAudioFrameDecodedOfUserAccount:(NSString* _Nonnull)userAccount elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:firstRemoteAudioFrameDecodedOfUserAccount:elapsed:)) __deprecated_msg("use rtcEngine:remoteAudioStateChangedOfUserAccount:state:reason:elapsed: instead.");
 ...
 * @param engine The AgoraRtcEngineKit object.
 * @param stats  The statistics of the received audio. See \ref AgoraRtcRemoteAudioStatsS.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine remoteAudioStats:(AgoraRtcRemoteAudioStatsS * _Nonnull)stats NS_SWIFT_NAME(rtcEngine(_:remoteAudioStats:));
...
/** A remote user's audio was muted or unmuted.
 ...
 @param userAccount    Remote user ID
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didAudioMuted:(BOOL)muted byUserAccount:(NSString* _Nonnull)userAccount NS_SWIFT_NAME(rtcEngine(_:didAudioMuted:byUserAccount:));
 ...
 * for each speaker: #AgoraRtcAudioVolumeInfoS.
 ...
 *   - `userAccount` of each remote speaker.
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine reportAudioVolumeIndicationOfSpeakers:(NSArray<AgoraRtcAudioVolumeInfoS *> * _Nonnull)speakers totalVolume:(NSInteger)totalVolume NS_SWIFT_NAME(rtcEngine(_:reportAudioVolumeIndicationOfSpeakers:totalVolume:));
 ...
 * active speaker in the channel. This callback also returns the `userAccount` of the
 * active speaker.
 *
 * @note
 ...
 * @param engine The AgoraRtcEngineKit object.
 * @param speakerUserAccount The ID of the active speaker. 
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine activeSpeaker:(NSString* _Nonnull)speakerUserAccount NS_SWIFT_NAME(rtcEngine(_:activeSpeaker:));
...
/** Occurs when a remote user starts audio mixing.
 ...
 @param engine AgoraRtcEngineKit object.
 */
- (void)rtcEngineRemoteAudioMixingDidStart:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineRemoteAudioMixingDidStart(_:));

/** The remote user ended audio mixing.

 @param engine AgoraRtcEngineKit object
 */
- (void)rtcEngineRemoteAudioMixingDidFinish:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineRemoteAudioMixingDidFinish(_:));

/** The audio quality of the specified user every two seconds. Same as [audioQualityBlock]([AgoraRtcEngineKit audioQualityBlock:]).

 @param engine  The AgoraRtcEngineKit object.
 @param userAccount     User ID of the speaker.
 @param quality AgoraNetworkQuality
 @param delay   Time delay (ms).
 @param lost    Packet loss rate (%).
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine audioQualityOfUserAccount:(NSString* _Nonnull)userAccount quality:(AgoraNetworkQuality)quality delay:(NSUInteger)delay lost:(NSUInteger)lost NS_SWIFT_NAME(rtcEngine(_:audioQualityOfUserAccount:quality:delay:lost:));
...
/** The remote audio transport statistics.
 ...
 @param engine     The AgoraRtcEngineKit object.
 @param userAccount        User ID of the remote user whose audio data packet has been received.
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine audioTransportStatsOfUserAccount:(NSString* _Nonnull)userAccount delay:(NSUInteger)delay lost:(NSUInteger)lost rxKBitRate:(NSUInteger)rxKBitRate NS_SWIFT_NAME(rtcEngine(_:audioTransportStatsOfUserAccount:delay:lost:rxKBitRate:));


/** Intra request received.
 * @param engine  The AgoraRtcEngineKit object.
*/
- (void)rtcEngineIntraRequestReceived:(AgoraRtcEngineKitS* _Nonnull)engine NS_SWIFT_NAME(rtcEngineIntraRequestReceived(_:));

/** Target bitrate updated.
 * @param engine   The AgoraRtcEngineKit object.
 * @param networkInfo  The uplink network info, including target bitrate bps.
*/
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine uplinkNetworkInfoUpdate:(AgoraUplinkNetworkInfo *_Nonnull)networkInfo NS_SWIFT_NAME(rtcEngine(_:uplinkNetworkInfoUpdate:));

/** Downlink network info updated.
 * @param engine       The AgoraRtcEngineKit object.
 * @param networkInfo  The network info.
*/
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine downlinkNetworkInfoUpdate:(AgoraDownlinkNetworkInfo *_Nonnull)networkInfo NS_SWIFT_NAME(rtcEngine(_:downlinkNetworkInfoUpdate:));
 ...
 * @param userAccount The remote user ID that is subscribed to.
...
*/
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine didAudioSubscribeStateChange:(NSString * _Nonnull)channelId
...
elapseSinceLastState:(int)elapseSinceLastState NS_SWIFT_NAME(rtcEngine(_:didAudioSubscribeStateChange:userAccount:oldState:newState:elapseSinceLastState:));
 ...
 * @param elapseSinceLastState The time elapsed (ms) from the old state to the new state.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine didAudioPublishStateChange:(NSString * _Nonnull)channelId
...
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didRhythmPlayerStateChanged:(AgoraRhythmPlayerState)state
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didLocalVideoTranscoderErrorWithStream:(AgoraTranscodingVideoStreamS * _Nonnull )stream
...
/** Occurs when the first frame of the remote user was decoded successfully.
 ...
 @deprecated This callback is deprecated. Use [remoteVideoStateChangedOfUserAccount](remoteVideoStateChangedOfUserAccount:state:reason:elapsed:)
   instead.
 ...
 @param engine  The AgoraRtcEngineKit object.
 @param userAccount     ID of the user whose video streams are received.
 @param size    Size of the video (width and height) in pixels.
 @param elapsed Time elapsed (ms) from calling `joinChannelByToken` until this callback is triggered.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine firstRemoteVideoDecodedOfUserAccount:(NSString* _Nonnull)userAccount size:(CGSize)size elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:firstRemoteVideoDecodedOfUserAccount:size:elapsed:)) __deprecated_msg("use rtcEngine:remoteVideoStateChangedOfUserAccount:state:reason: instead.");
...
/** The first frame of the remote user was displayed successfully. Same as [firstRemoteVideoFrameBlock]([AgoraRtcEngineKit firstRemoteVideoFrameBlock:]).
 ...
 @param elapsed Time elapsed (ms) from calling `joinChannelByToken` until this callback is triggered.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine firstRemoteVideoFrameOfUserAccount:(NSString* _Nonnull)userAccount size:(CGSize)size elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:firstRemoteVideoFrameOfUserAccount:size:elapsed:));
  ...
  */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine videoSizeChangedOfSourceType:(AgoraVideoSourceType)sourceType userAccount:(NSString* _Nonnull)userAccount size:(CGSize)size rotation:(NSInteger)rotation NS_SWIFT_NAME(rtcEngine(_:videoSizeChangedOf:userAccount:size:rotation:));
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine contentInspectResult:(AgoraContentInspectResult)result NS_SWIFT_NAME(rtcEngine(_:contentInspectResult:));
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine snapshotTaken:(NSString* _Nonnull)userAccount filePath:(NSString* _Nonnull)filePath width:(NSInteger)width height:(NSInteger)height errCode:(NSInteger)errCode NS_SWIFT_NAME(rtcEngine(_:snapshotTaken:filePath:width:height:errCode:));
 ...
 * @param sourceType source type of the orignated video source. See \ref AgoraVideoSourceType.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine localVideoStateChangedOfState:(AgoraVideoLocalState)state error:(AgoraLocalVideoStreamError)error sourceType:(AgoraVideoSourceType)sourceType NS_SWIFT_NAME(rtcEngine(_:localVideoStateChangedOf:error:sourceType:));
 ...
 *
 * @param engine AgoraRtcEngineKit object.
 * @param userAccount    ID of the user whose video state has changed.
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine remoteVideoStateChangedOfUserAccount:(NSString* _Nonnull)userAccount state:(AgoraVideoRemoteState)state reason:(AgoraVideoRemoteReason)reason elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:remoteVideoStateChangedOfUserAccount:state:reason:elapsed:));

/**
 * Occurs when the state of a remote audio stream changes.
 *
 * @param engine The AgoraRtcEngineKit object.
 * @param userAccount    The ID of the user whose audio state has changed.
 ...
 * @param elapsed The time elapsed (ms) from calling `joinChannelByToken` until the SDK triggers this callback.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine remoteAudioStateChangedOfUserAccount:(NSString* _Nonnull)userAccount state:(AgoraAudioRemoteState)state reason:(AgoraAudioRemoteReason)reason elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:remoteAudioStateChangedOfUserAccount:state:reason:elapsed:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine
 ...
 * No: Remote user's video resumed.
 ...
 @param userAccount    Remote user ID.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didVideoMuted:(BOOL)muted byUserAccount:(NSString* _Nonnull)userAccount NS_SWIFT_NAME(rtcEngine(_:didVideoMuted:byUserAccount:)) __deprecated_msg("use rtcEngine:remoteVideoStateChangedOfUserAccount:state:reason: instead.");
 ...
 * No: User has disabled the video function.
 ...
 @param userAccount     Remote user ID.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didVideoEnabled:(BOOL)enabled byUserAccount:(NSString* _Nonnull)userAccount NS_SWIFT_NAME(rtcEngine(_:didVideoEnabled:byUserAccount:));
 ...
 * No: User has disabled the local video function.
 ...
 @param userAccount     Remote user ID.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didLocalVideoEnabled:(BOOL)enabled byUserAccount:(NSString* _Nonnull)userAccount NS_SWIFT_NAME(rtcEngine(_:didLocalVideoEnabled:byUserAccount:)) __deprecated_msg("use rtcEngine:remoteVideoStateChangedOfUserAccount:state:reason: instead.");

/** Occurs when join success after calling [setLocalAccessPoint]([AgoraRtcEngineKit setLocalAccessPoint:channelId:info:userAccount:joinSuccess:]) or [setCloudProxy]([AgoraRtcEngineKit setCloudProxy:proxyType])
 @param engine  AgoraRtcEngineKit object.
 @param channel Channel name.
 @param userAccount     User ID. If the `userAccount` is specified in the [joinChannelByToken]([AgoraRtcEngineKit joinChannelByToken:channelId:info:userAccount:joinSuccess:]) method, the  specified user ID is returned. If the user ID is not specified when the joinChannel method is called, the server automatically assigns a `userAccount`.
 ...
 @param elapsed Time elapsed (ms) from the user calling the [joinChannelByToken]([AgoraRtcEngineKit joinChannelByToken:channelId:info:userAccount:joinSuccess:]) method until the SDK triggers this callback.
  */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine didProxyConnected:(NSString* _Nonnull)channel withUserAccount:(NSString* _Nonnull)userAccount proxyType:(AgoraProxyType)proxyType localProxyIp:(NSString* _Nonnull)localProxyIp elapsed:(NSInteger)elapsed NS_SWIFT_NAME(rtcEngine(_:didProxyConnected:withUserAccount:proxyType:localProxyIp:elapsed:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine remoteUserStateChangedOfUserAccount:(NSString* _Nonnull)userAccount state:(NSUInteger)state NS_SWIFT_NAME(rtcEngine(_:remoteUserStateChangedOfUserAccount:state:));
 ...
 * #AgoraRtcRemoteVideoStatsS.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine remoteVideoStats:(AgoraRtcRemoteVideoStatsS * _Nonnull)stats NS_SWIFT_NAME(rtcEngine(_:remoteVideoStats:));
 ...
 * NO: The remote subscribe stream switched back to the video stream when the network conditions improved.
 @param userAccount                 Remote user ID
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine didRemoteSubscribeFallbackToAudioOnly:(BOOL)isFallbackOrRecover byUserAccount:(NSString* _Nonnull)userAccount NS_SWIFT_NAME(rtcEngine(_:didRemoteSubscribeFallbackToAudioOnly:byUserAccount:));
...
/** The remote video transport statistics.
 ...
 @param engine     The AgoraRtcEngineKit object.
 @param userAccount        User ID of the remote user whose video packet has been received.
 @param delay      Time delay (ms) from the remote user to the local client.
 @param lost       Packet loss rate (%).
 @param rxKBitRate Received video bitrate (kbit/s) of the packet from the remote user.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine videoTransportStatsOfUserAccount:(NSString* _Nonnull)userAccount delay:(NSUInteger)delay lost:(NSUInteger)lost rxKBitRate:(NSUInteger)rxKBitRate NS_SWIFT_NAME(rtcEngine(_:videoTransportStatsOfUserAccount:delay:lost:rxKBitRate:));
 ...
 * @param elapseSinceLastState The time elapsed (ms) from the old state to the new state.
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine didVideoSubscribeStateChange:(NSString * _Nonnull)channelId
        userAccount:(NSString * _Nonnull)userAccount
           oldState:(AgoraStreamSubscribeState)oldState
           newState:(AgoraStreamSubscribeState)newState
elapseSinceLastState:(int)elapseSinceLastState NS_SWIFT_NAME(rtcEngine(_:didVideoSubscribeStateChange:userAccount:oldState:newState:elapseSinceLastState:));
 ...
 * @param elapseSinceLastState The time elapsed (ms) from the old state to the new state.
*/
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine didVideoPublishStateChange:(NSString * _Nonnull)channelId
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine rtmpStreamingChangedToState:(NSString* _Nonnull)url state:(AgoraRtmpStreamingState)state errCode:(AgoraRtmpStreamingErrorCode)errCode NS_SWIFT_NAME(rtcEngine(_:rtmpStreamingChangedToState:state:errCode:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine rtmpStreamingEventWithUrl:(NSString* _Nonnull)url eventCode:(AgoraRtmpStreamingEvent)eventCode NS_SWIFT_NAME(rtcEngine(_:rtmpStreamingEventWithUrl:eventCode:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine streamPublishedWithUrl:(NSString * _Nonnull)url errorCode:(AgoraErrorCode)errorCode NS_SWIFT_NAME(rtcEngine(_:streamPublishedWithUrl:errorCode:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine streamUnpublishedWithUrl:(NSString * _Nonnull)url NS_SWIFT_NAME(rtcEngine(_:streamUnpublishedWithUrl:));

/** The publisher transcoding was updated.

 @param engine The AgoraRtcEngineKit object.
 */
- (void)rtcEngineTranscodingUpdated:(AgoraRtcEngineKitS *_Nonnull)engine NS_SWIFT_NAME(rtcEngineTranscodingUpdated(_:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine streamInjectedStatusOfUrl:(NSString * _Nonnull)url userAccount:(NSString* _Nonnull)userAccount status:(AgoraInjectStreamStatus)status NS_SWIFT_NAME(rtcEngine(_:streamInjectedStatusOfUrl:userAccount:status:));
...
*/
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine audioMixingStateChanged:(AgoraAudioMixingStateType)state
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine audioMixingPositionChanged:(NSInteger)position NS_SWIFT_NAME(rtcEngine(_:audioMixingPositionChanged:));
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKitS* _Nonnull)engine facePositionDidChangeWidth:(int)width previewHeight:(int)height faces:(NSArray<AgoraFacePositionInfo*>* _Nullable)faces  NS_SWIFT_NAME(rtcEngine(_:facePositionDidChangeWidth:previewHeight:faces:));
#endif
...
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine localVideoStats:(AgoraRtcLocalVideoStatsS * _Nonnull)stats NS_SWIFT_NAME(rtcEngine(_:localVideoStats:)) __attribute__((availability(ios,deprecated=7_0,message="Use rtcEngine:localVideoStats:sourceType instead.")));
...
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine videoSizeChangedOfUserAccount:(NSString* _Nonnull)userAccount size:(CGSize)size rotation:(NSInteger)rotation NS_SWIFT_NAME(rtcEngine(_:videoSizeChangedOfUserAccount:size:rotation:)) __attribute__((availability(ios,deprecated=7_0,message="Use rtcEngine:videoSizeChangedOfSourceType:userAccount:size:rotation instead.")));
#endif
...
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine localVideoStats:(AgoraRtcLocalVideoStatsS * _Nonnull)stats NS_SWIFT_NAME(rtcEngine(_:localVideoStats:)) __attribute__((availability(macos,deprecated=10_9,message="Use rtcEngine:localVideoStats:sourceType instead.")));
...
- (void)rtcEngine:(AgoraRtcEngineKitS *_Nonnull)engine videoSizeChangedOfUserAccount:(NSString* _Nonnull)userAccount size:(CGSize)size rotation:(NSInteger)rotation NS_SWIFT_NAME(rtcEngine(_:videoSizeChangedOfUserAccount:size:rotation:)) __attribute__((availability(macos,deprecated=10_9,message="Use rtcEngine:videoSizeChangedOfSourceType:userAccount:size:rotation instead.")));
#endif
@end
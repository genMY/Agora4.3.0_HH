...
namespace LiveAPM {
  template <class T, class D = LiveRTC::DefaultDeleter<T> >
  class scoped_ptr {
...
//        : impl_(&other.impl_) {
//            // static_assert(!LiveRTC::is_array<U>::value, "U cannot be an array");
//        }
//
...
//        }
  ...
  private:
    typedef LiveRTC::internal::scoped_ptr_impl<element_type, deleter_type>
    scoped_ptr::*Testable;
  ...
  private:
    ...
    LiveRTC::internal::scoped_ptr_impl<element_type, deleter_type> impl_;

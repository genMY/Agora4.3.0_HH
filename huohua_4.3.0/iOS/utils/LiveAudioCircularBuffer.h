...
#include "live_scoped_ptr.h"
#include <string.h>
template <typename  Ty>

class LiveAudioCircularBuffer {
    
  public:
    typedef Ty value;
    LiveAudioCircularBuffer(uint32_t initSize, bool newWay)
    ...
    LiveRTC::scoped_array<value> pInt16Buffer;
